...
Make sure you're added as a contributor to [the github repo](https://github.com/CarrierOps/gcp_carrier_data_backup). (If you click on the link and you can see things, then you're good to go, if not, contact Thomas or Michael to be added as a contributor).
...
> :bulb: **Quick-Tip**
>
> - After cloning the github repo, cd into it. From the command line, type `cd gcp_carrier_data_backup` 
...
<figure align="center">
    <img src="../../../imgs/data-backup-sync.png" width="95%">
  <figcaption>High-level diagram showing the how data-backup-sync Cloud Function DevOps works.</figcaption>
</figure>
