...
> :bulb: **Quick-Tip**
>
> - After cloning the github repo, cd into it. From the command line, type `cd trigger_wkly` then hit <kbd>tab</kbd> to auto-complete then hit <kbd>enter</kbd>
>
...
<figure align="center">
    <img src="../../../imgs/trigger_wkly_acts_high_level.png" width="95%">
